              ...
              <div class="orders-list-wrapper">
                ...
                <AppCard v-else v-for="order in pendingOrders" :key="order.id" class="order-item-card" variant="default" paddingSize="md" style="margin-bottom: var(--space-3);">
                  ...
                  <div class="order-middle-row" style="margin: var(--space-2) 0;">
                    ...
                    <p class="order-desc-detail" style="font-size: var(--font-size-xs); color: var(--color-neutral-700); margin: 0;">{{ order.quantity_ordered }}x {{ order.product?.name || 'Produce' }} • Drop-off: {{ order.delivery_address || order.buyer?.location || 'Takoradi Market Circle' }}</p>
